...
cifar10 = torchvision.datasets.CIFAR10(root='/Users/limingxia/desktop/study/AI/cifar10-CNN/cifar10_data',
                                       train=True,
...
def RNN(_X, _istate, _weights, _biases):
    ...
    outputs, states = rnn.dynamic_rnn(
        lstm_cell, _X, initial_state=_istate)
...
with tf.Session() as sess:
    ...
    # 载入测试集进行测试
    test_len = 256
    test_data = cifar10.test.images[:test_len].reshape((-1, n_steps, n_input))
    test_label = cifar10.test.labels[:test_len]
